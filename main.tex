...
\maketitle{%
  ...
  With the Battleship Solitaire puzzle and the mathematical formulations, ILP performance was governed by matrix sparsity and root-node relaxation rather than search tree pruning.
}
...
I would also like to thank my close ones who have supported me during this project. The behind-the-scenes encouragement helped more than you'll ever know. 
...
\begin{itemize}
  ...
  \item \textbf{Editorial review:} Claude flagged residual typos, grammatical errors, weak phrasing, and figure caption thinness across the report. Each flagged change was reviewed and either accepted in modified form or rejected. Suggestions were not pasted in full.
