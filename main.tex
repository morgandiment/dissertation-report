...
The CSPLib 014: Solitaire Battleship problem instance data is available: https://www.csplib.org/Problems/prob014/data/.

\section{Code}
% Software or code produced in this work and where it is available (repository, DOI, etc.).
Code produced for this dissertation is available from: https://github.com/morgandiment/Battleship-ILP.

The LaTeX full report is available at: https://github.com/morgandiment/dissertation-report.

Gurobi was used under the Academic Named User License. More information is available at: https://www.gurobi.com/academics. 

\chapter{Declaration of AI Usage}

In accordance with the CM3203 project guidelines, I declare the us of AI assistive technologies during the development of this project. Specifically, Google's Gemini Large Language Model \citep{gemini} was utilised as an assistive programming and typesetting tool. Its primary applications included:
\begin{itemize}
