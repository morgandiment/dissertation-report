...
\maketitle{%
  ...
  Battleship Solitaire is a deterministic logic puzzle whose decision problem is NP-Complete, making it a useful testbed for advanced combinatorial optimisation techniques.
  This dissertation compares two Integer Linear Programming (ILP) formulations of the puzzle, originally proposed by Meuffels and den Hertog, and quantifies their behaviour under exponential scaling.
  A Cell-based model represents the grid as a per-cell state matrix, using shape-transition and adjacency constraints.
  ...
  A constraint ablation study further showed that valid inequalities are scale-dependent. At 900 cells, they reduce the solve time by approximately two seconds, but introduce overhead at smaller scales.
