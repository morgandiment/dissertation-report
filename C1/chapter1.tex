...
The main aim of the project is to determine the most computationally efficient Integer Linear Programming (ILP) paradigm for solving the NP-Complete Battleship Solitaire problem through comparative anaylsis of multiple ILP formulations.
